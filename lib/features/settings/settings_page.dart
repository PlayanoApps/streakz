...
class _SettingsPageState extends State<SettingsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          MyAppBar(title: "Settings", bottomPadding: 0),
                ...
                ListView(
                  ...
                  children: [
                    ...
                    SettingsTile(
                      onTap: () {
                        HapticFeedback.lightImpact();
                        final notiServiceProvider =
                            Provider.of<NotiServiceProvider>(
                              context,
                              listen: false,
                            );
                        bool currentValue =
                            notiServiceProvider.notificationsEnabled;
